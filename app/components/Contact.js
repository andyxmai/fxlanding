    ...
    <Element name="contact" className="element">
      <div id='contact' style={contact}>
        <div style={formHeading}>
          <h2 style={{marginBottom: '25px'}}>Take the first step</h2>
          <p style={{width: '40%'}}>Working with foreign clients? Dealing with multiple foreign currencies in your business? Contact us to see how we can make your business risk-free and protect your bottom line.</p>
        </div>
        {(() => {
          switch (messageType) {
